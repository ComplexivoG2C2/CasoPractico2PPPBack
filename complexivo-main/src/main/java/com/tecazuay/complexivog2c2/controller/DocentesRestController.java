...
public class DocentesRestController {
    ...
    public ResponseEntity<?> saveDirector(@RequestBody TutorEmpresarialProyectoRequest tutorEmpresarialProyectoRequest) {
        tutorEmpresarialService.saveRolDirector(tutorEmpresarialProyectoRequest);
    ...
    public ResponseEntity<?> directorDatos(@PathVariable Long idProyecto) {
        TutorEmpresarialProyectoResponse response = tutorEmpresarialService.getDirector(idProyecto);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteDirector(@PathVariable Long id) {
        tutorEmpresarialService.deleteById(id);
    ...
    public ResponseEntity<?> getCedulaDirectorByIdProyecto(@PathVariable Long id) {
        return new ResponseEntity<>(tutorEmpresarialService.getCedulaDirectorByProject(id), HttpStatus.OK);
    }
